  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 px-5">
        ...
        {/* 2 & 3 — side-by-side secondary cards */}
        <div className="flex gap-3">
          ...
          <button
            ...
            style={{
              ...
              boxShadow: '0 2px 12px rgba(200,169,106,0.14)',
            }}
          ...
          <button
            ...
            style={{
              ...
              boxShadow: '0 2px 8px rgba(59,42,31,0.05)',
            }}
